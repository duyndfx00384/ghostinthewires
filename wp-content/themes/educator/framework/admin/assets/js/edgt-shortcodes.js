				...
				},
				{
					...
					onclick: function() {
						ed.windowManager.open( {
							...
							onsubmit: function( e ) {
								ed.insertContent( '[edgt_inner_row_holder space_between_columns="' + e.data.space_between_columns + '" text_alignment="' + e.data.text_alignment + '"][edgt_inner_row_column column_size="6"]Left column text content[/edgt_inner_row_column][edgt_inner_row_column column_size="6"]Right column text content[/edgt_inner_row_column][/edgt_inner_row_holder]');
							}
						});
					}
				},
