...
class EducatorEdgeLinearIcons implements iEducatorEdgeIconCollection {
	...
	public function render($icon, $params = array()) {
		...
		$html .= '<span aria-hidden="true" class="edgt-icon-linear-icons lnr ' . $icon . ' ' . $iconClass . '" ' . $iconAttributesString . '></span>';
