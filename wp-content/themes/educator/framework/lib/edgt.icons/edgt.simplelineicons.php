...
class EducatorEdgeSimpleLineIcons implements iEducatorEdgeIconCollection {
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'educator'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'educator'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'educator'),
            'icon-social-facebook'    => esc_html__('Facebook', 'educator'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'educator'),
            'icon-social-github'      => esc_html__('Github', 'educator'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'educator'),
            'icon-social-instagram'   => esc_html__('Instagram', 'educator'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'educator'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'educator'),
            'icon-social-reddit'      => esc_html__('Reddit', 'educator'),
            'icon-social-skype'       => esc_html__('Skype', 'educator'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'educator'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'educator'),
            'icon-social-spotify'     => esc_html__('Spotify', 'educator'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'educator'),
            'icon-social-twitter'     => esc_html__('Twitter', 'educator'),
            'icon-social-youtube'     => esc_html__('Youtube', 'educator')
        );
    }
