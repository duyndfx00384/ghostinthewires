...
if ( ! function_exists('educator_edge_error_404_options_map') ) {

	function educator_edge_error_404_options_map() {
		
		educator_edge_add_admin_page(
			array(
				'slug'  => '__404_error_page',
				'title' => esc_html__( '404 Error Page', 'educator' ),
				'icon'  => 'fa fa-exclamation-triangle'
			)
		);
		
		$panel_404_header = educator_edge_add_admin_panel(
			array(
		...
		educator_edge_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'Choose a border bottom color for header area', 'educator' )
			)
		);
		...
		$panel_404_options = educator_edge_add_admin_panel(
			array(
				'page'  => '__404_error_page',
				'name'  => 'panel_404_options',
				'title' => esc_html__( '404 Page Options', 'educator' )
			)
		);
		...
		educator_edge_add_admin_field(
			array(
				...
				'description' => esc_html__( 'Choose a background image for 404 page', 'educator' )
			)
		);
		...
		educator_edge_add_admin_field(
			array(
				...
				'description' => esc_html__( 'Choose a pattern image for 404 page', 'educator' )
			)
		);
		...
		educator_edge_add_admin_field(
			array(
				...
				'label'       => esc_html__( 'Title Image', 'educator' ),
				'description' => esc_html__( 'Choose a background image for displaying above 404 page Title', 'educator' )
			)
		);
		...
		educator_edge_add_admin_field(
			array(
				...
				'name'          => '404_title',
				'default_value' => '',
				'label'         => esc_html__( 'Title', 'educator' ),
				'description'   => esc_html__( 'Enter title for 404 page. Default label is "404".', 'educator' )
			)
		);
		...
		$first_level_group = educator_edge_add_admin_group(
			array(
				...
				'title'       => esc_html__( 'Title Style', 'educator' ),
				'description' => esc_html__( 'Define styles for 404 page title', 'educator' )
			)
		);
		...
		$first_level_row2 = educator_edge_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		educator_edge_add_admin_field(
			array(
				...
				'name'          => '404_subtitle',
				'default_value' => '',
				'label'         => esc_html__( 'Subtitle', 'educator' ),
				'description'   => esc_html__( 'Enter subtitle for 404 page. Default label is "PAGE NOT FOUND".', 'educator' )
			)
		);
		...
		$second_level_group = educator_edge_add_admin_group(
			array(
				...
				'title'       => esc_html__( 'Subtitle Style', 'educator' ),
				'description' => esc_html__( 'Define styles for 404 page subtitle', 'educator' )
			)
		);
		...
		educator_edge_add_admin_field(
			array(
				...
				'name'          => '404_text',
				'default_value' => '',
				'label'         => esc_html__( 'Text', 'educator' ),
				'description'   => esc_html__( 'Enter text for 404 page.', 'educator' )
			)
		);
		...
		$third_level_group = educator_edge_add_admin_group(
			array(
				...
				'title'       => esc_html__( 'Text Style', 'educator' ),
				'description' => esc_html__( 'Define styles for 404 page text', 'educator' )
			)
		);
		...
		educator_edge_add_admin_field(
			array(
				...
				'label'       => esc_html__( 'Back to Home Button Label', 'educator' ),
				'description' => esc_html__( 'Enter label for "BACK TO HOME" button', 'educator' )
			)
		);
		...
		educator_edge_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Skin', 'educator' ),
				'description'   => esc_html__( 'Choose a style to make Back to Home button in that predefined style', 'educator' ),
				'options'       => array(
					''            => esc_html__( 'Default', 'educator' ),
					'light-style' => esc_html__( 'Light', 'educator' )
				)
			)
		);
	}

	add_action( 'educator_edge_options_map', 'educator_edge_error_404_options_map', 19);
}