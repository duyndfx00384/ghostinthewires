...
class HeaderStandard extends HeaderType {
	...
	public function loadTemplate( $parameters = array() ) {
		...
		$menu_area_position                     = educator_edge_get_meta_field_intersect( 'set_menu_area_position', $page_id );
		$parameters['menu_area_position']       = ! empty( $menu_area_position ) ? $menu_area_position : 'right';
		$parameters['menu_area_position_class'] = ! empty( $menu_area_position ) ? 'edgt-menu-' . $menu_area_position : 'edgt-menu-right';
		
		$parameters = apply_filters( 'educator_edge_header_standard_parameters', $parameters );
