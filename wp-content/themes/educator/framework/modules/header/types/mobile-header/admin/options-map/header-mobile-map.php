...
if ( ! function_exists( 'educator_edge_mobile_header_options_map' ) ) {
	function educator_edge_mobile_header_options_map() {

        educator_edge_add_admin_page(
            array(
                'slug'  => '_mobile_header',
                'title' => esc_html__( 'Mobile Header', 'educator' ),
                'icon'  => 'fa fa-mobile'
            )
        );
		
		$panel_mobile_header = educator_edge_add_admin_panel(
			array(
				'title' => esc_html__( 'Mobile Header', 'educator' ),
		...
		$mobile_header_group = educator_edge_add_admin_group(
			array(
				'parent' => $panel_mobile_header,
				'name'   => 'mobile_header_group',
				'title'  => esc_html__( 'Mobile Header Styles', 'educator' )
			)
		);
		
		$mobile_header_row1 = educator_edge_add_admin_row(
			array(
		...
		educator_edge_add_admin_field(
			array(
				...
				'type'   => 'colorsimple',
				'label'  => esc_html__( 'Border Bottom Color', 'educator' ),
				'parent' => $mobile_header_row1
			)
		);
		
		$mobile_menu_group = educator_edge_add_admin_group(
			array(
				'parent' => $panel_mobile_header,
				'name'   => 'mobile_menu_group',
				'title'  => esc_html__( 'Mobile Menu Styles', 'educator' )
			)
		);
		
		$mobile_menu_row1 = educator_edge_add_admin_row(
			array(
		...
		educator_edge_add_admin_field(
			array(
				...
				'type'   => 'colorsimple',
				'label'  => esc_html__( 'Menu Item Separator Color', 'educator' ),
				'parent' => $mobile_menu_row1
			)
		);
		...
		educator_edge_add_admin_field(
			array(
				...
				'type'        => 'text',
				'label'       => esc_html__( 'Logo Height For Mobile Header', 'educator' ),
				'description' => esc_html__( 'Define logo height for screen size smaller than 1024px', 'educator' ),
				'parent'      => $panel_mobile_header,
				'args'        => array(
					'col_width' => 3,
					'suffix'    => 'px'
		...
		educator_edge_add_admin_field(
			array(
				...
				'type'        => 'text',
				'label'       => esc_html__( 'Logo Height For Mobile Devices', 'educator' ),
				'description' => esc_html__( 'Define logo height for screen size smaller than 480px', 'educator' ),
				'parent'      => $panel_mobile_header,
				'args'        => array(
					'col_width' => 3,
					'suffix'    => 'px'
		...
		$first_level_group = educator_edge_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Define styles for 1st level in Mobile Menu Navigation', 'educator' )
			)
		);
		...
		$second_level_group = educator_edge_add_admin_group(
			array(
				...
				'title'       => esc_html__( 'Dropdown Menu', 'educator' ),
				'description' => esc_html__( 'Define styles for drop down menu items in Mobile Menu Navigation', 'educator' )
			)
		);
		...
		educator_edge_add_admin_section_title(
			array(
				...
				'parent' => $panel_mobile_header,
				'title'  => esc_html__( 'Mobile Menu Opener', 'educator' )
			)
		);
		...
		educator_edge_add_admin_field(
			array(
				...
				'type'        => 'text',
				'label'       => esc_html__( 'Mobile Navigation Title', 'educator' ),
				'description' => esc_html__( 'Enter title for mobile menu navigation', 'educator' ),
				'parent'      => $panel_mobile_header,
				'args'        => array(
					'col_width' => 3
				)
		...
		educator_edge_add_admin_field(
			array(
				...
				'type'   => 'color',
				'label'  => esc_html__( 'Mobile Navigation Icon Color', 'educator' ),
				'parent' => $panel_mobile_header
			)
		);
		...
		educator_edge_add_admin_field(
			array(
				...
				'type'   => 'color',
				'label'  => esc_html__( 'Mobile Navigation Icon Hover Color', 'educator' ),
				'parent' => $panel_mobile_header
			)
		);
	}
	
	add_action( 'educator_edge_mobile_header_options_map', 'educator_edge_mobile_header_options_map', 5 );
}