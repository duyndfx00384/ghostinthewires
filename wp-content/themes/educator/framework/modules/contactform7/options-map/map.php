...
if ( ! function_exists('educator_edge_contact_form_7_options_map') ) {

	function educator_edge_contact_form_7_options_map() {

		educator_edge_add_admin_page(array(
			'slug'	=> '_contact_form7_page',
			'title'	=> esc_html__('Contact Form 7', 'educator'),
			'icon'	=> 'fa fa-envelope-o'
		));

		$panel_contact_form_style_1 = educator_edge_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_1',
			'title'	=> esc_html__('Custom Style 1', 'educator')
		));

		//Text Typography

		$typography_text_group = educator_edge_add_admin_group(array(
			'name'			=> 'typography_text_group',
			'title'			=> esc_html__('Form Text Typography', 'educator'),
			'description'	=> esc_html__('Setup typography for form elements text', 'educator'),
			'parent'		=> $panel_contact_form_style_1
		));

		$typography_text_row1 = educator_edge_add_admin_row(array(
		...
		educator_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Text Color', 'educator'),
		));
		...
		$typography_text_row2 = educator_edge_add_admin_row(array(
		...
		$typography_text_row3 = educator_edge_add_admin_row(array(
		...
		$typography_label_group = educator_edge_add_admin_group(array(
			'name'			=> 'typography_label_group',
			'title'			=> esc_html__('Form Label Typography', 'educator'),
			'description'	=> esc_html__('Setup typography for form elements label', 'educator'),
			'parent'		=> $panel_contact_form_style_1
		));

		$typography_label_row1 = educator_edge_add_admin_row(array(
		...
		$typography_label_row2 = educator_edge_add_admin_row(array(
		...
		$background_border_group = educator_edge_add_admin_group(array(
			'name'			=> 'background_border_group',
			'title'			=> esc_html__('Form Elements Background and Border', 'educator'),
			'description'	=> esc_html__('Setup form elements background and border style', 'educator'),
			'parent'		=> $panel_contact_form_style_1
		));

		$background_border_row1 = educator_edge_add_admin_row(array(
		...
		educator_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Background Color', 'educator')
		));
		...
		educator_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Background Transparency', 'educator')
		));

		$background_border_row2 = educator_edge_add_admin_row(array(
		...
		educator_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Transparency', 'educator'),
		));
		...
		educator_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Border Color', 'educator')
		));
		...
		educator_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Border Transparency', 'educator')
		));

		$background_border_row3 = educator_edge_add_admin_row(array(
		...
		educator_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Width', 'educator'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		educator_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Radius', 'educator'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		$padding_group = educator_edge_add_admin_group(array(
			'name'			=> 'padding_group',
			'title'			=> esc_html__('Elements Padding', 'educator'),
			'description'	=> 'Setup form elements padding',
			'parent'		=> $panel_contact_form_style_1
		));

		$padding_row = educator_edge_add_admin_row(array(
			'name'		=> 'padding_row',
		...
		educator_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Top', 'educator'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		educator_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Right', 'educator'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		educator_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Bottom', 'educator'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		educator_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Left', 'educator'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		$margin_group = educator_edge_add_admin_group(array(
			'name'			=> 'margin_group',
			'title'			=> esc_html__('Elements Margin', 'educator'),
			'description'	=> esc_html__('Setup form elements margin', 'educator'),
			'parent'		=> $panel_contact_form_style_1
		));

		$margin_row = educator_edge_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		educator_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Textarea Height', 'educator'),
			'description'	=> esc_html__('Enter height for textarea form element', 'educator'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		$button_typography_group = educator_edge_add_admin_group(array(
			'name'			=> 'button_typography_group',
			'title'			=> esc_html__('Button Typography', 'educator'),
			'description'	=> esc_html__('Setup button text typography', 'educator'),
			'parent'		=> $panel_contact_form_style_1
		));

		$button_typography_row1 = educator_edge_add_admin_row(array(
		...
		$button_typography_row2 = educator_edge_add_admin_row(array(
		...
		$button_background_border_group = educator_edge_add_admin_group(array(
			'name'			=> 'button_background_border_group',
			'title'			=> esc_html__('Button Background and Border', 'educator'),
			'description'	=> esc_html__('Setup button background and border style', 'educator'),
			'parent'		=> $panel_contact_form_style_1
		));

		$button_background_border_row1 = educator_edge_add_admin_row(array(
		...
		educator_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Background Hover Color', 'educator')
		));
		...
		educator_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Background Hover Transparency', 'educator')
		));

		$button_background_border_row2 = educator_edge_add_admin_row(array(
		...
		educator_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Hover Color', 'educator')
		));
		...
		educator_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Hover Transparency', 'educator')
		));

		$button_background_border_row3 = educator_edge_add_admin_row(array(
		...
		educator_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Button Height', 'educator'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		educator_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Button Left/Right Padding', 'educator'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		$panel_contact_form_style_2 = educator_edge_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_2',
			'title'	=> esc_html__('Custom Style 2', 'educator')
		));
        ...
        $panel_contact_form_style_3 = educator_edge_add_admin_panel(array(
            'page'	=> '_contact_form7_page',
            'name'	=> 'panel_contact_form_style_3',
            'title'	=> esc_html__('Custom Style 3', 'educator')
        ));
        ...
        $typography_label_row3 = educator_edge_add_admin_row(array(
        ...
        $button_typography_row3 = educator_edge_add_admin_row(array(
	...
	add_action( 'educator_edge_options_map', 'educator_edge_contact_form_7_options_map', 20);
}