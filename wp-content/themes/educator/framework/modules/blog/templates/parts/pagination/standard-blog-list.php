<?php if($max_num_pages > 1) { ?>
	...
	<?php
		...
		if($number_of_pages > 1){ ?>
			<div class="edgt-bl-standard-pagination">
				<ul>
					<li class="edgt-bl-pag-prev">
					...
					<?php for ($i=1; $i <= $number_of_pages; $i++) { ?>
						<?php
							$active_class = '';
							if($current_page == $i) {
								$active_class = 'edgt-bl-pag-active';
							}
						?>
						<li class="edgt-bl-pag-number <?php echo esc_attr($active_class); ?>">
							<a href="#" data-paged="<?php echo esc_attr($i); ?>"><?php echo esc_html($i); ?></a>
						</li>
					<?php } ?>
					<li class="edgt-bl-pag-next">
