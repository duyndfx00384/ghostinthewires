<article id="post-<?php the_ID(); ?>" <?php post_class($post_classes); ?>>
    <div class="edgt-post-content">
        <div class="edgt-post-heading">
            <?php educator_edge_get_module_template_part('templates/parts/image', 'blog', '', $part_params); ?>
            <?php educator_edge_get_module_template_part('templates/parts/post-type/audio', 'blog', '', $part_params); ?>
        </div>
        <div class="edgt-post-text">
            <div class="edgt-post-text-inner">
                ...
                <div class="edgt-post-text-main">
                    <?php educator_edge_get_module_template_part('templates/parts/excerpt', 'blog', '', $part_params); ?>
