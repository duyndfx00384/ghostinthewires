...
if( !function_exists('educator_edge_get_blog_single_holder_classes') ) {
    /**
     * Function that generates blog holder classes for single blog page
     */
    function educator_edge_get_blog_single_holder_classes($classes) {
        $sidebar_classes   = array();
        $sidebar_classes[] = 'edgt-grid-large-gutter';
    ...
    add_filter( 'educator_edge_blog_single_holder_classes', 'educator_edge_get_blog_single_holder_classes' );
}
