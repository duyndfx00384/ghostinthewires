...
$edgt_rev_style = array();

if ( $enable_paspartu === 'yes' ) {
	$css_class .= ' edgt-rev-has-paspartu';
	
	if ( ! empty( $paspartu_size ) ) {
		$css_class .= ' edgt-paspartu-' . $paspartu_size;
	}
	
	if ( $disable_side_paspartu === 'yes' ) {
		$css_class .= ' edgt-side-paspartu-disabled';
	}
	
	if ( $disable_top_paspartu === 'yes' ) {
		$css_class .= ' edgt-top-paspartu-disabled';
	}
}
