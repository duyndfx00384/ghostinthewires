<?php
if ( ! function_exists( 'educator_edge_init_google_fonts_array' ) ) {
    function educator_edge_init_google_fonts_array() {

        global $educator_edge_fonts_array;
        $educator_edge_fonts_array =
        array (
            0 =>
                array (
    ...
    add_action('after_setup_theme', 'educator_edge_init_google_fonts_array');
}