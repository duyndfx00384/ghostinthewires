...
class Dropcaps implements Lib\ShortcodeInterface {
	...
	public function render( $atts, $content = null ) {
		...
		$html = edgt_core_get_shortcode_module_template_part( 'templates/dropcaps-template', 'dropcaps', '', $params );
	...
	private function getDropcapsClass( $params ) {
		return ! empty( $params['type'] ) ? 'edgt-' . $params['type'] : '';
	}
}