...
class GoogleMap implements Lib\ShortcodeInterface {
	...
	public function render( $atts, $content = null ) {
		...
		$params['map_id']   = 'edgt-map-' . $rand_id;

		$html = edgt_core_get_shortcode_module_template_part( 'templates/google-map-template', 'google-map', '', $params );
