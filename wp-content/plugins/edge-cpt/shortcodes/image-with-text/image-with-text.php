...
class ImageWithText implements Lib\ShortcodeInterface {
	...
	public function __construct() {
		$this->base = 'edgt_image_with_text';
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Edge Image With Text', 'edge-cpt' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Custom Link', 'edge-cpt' ),
	...
	public function render( $atts, $content = null ) {
		...
		$html = edgt_core_get_shortcode_module_template_part( 'templates/image-with-text', 'image-with-text', '', $params );
	...
	private function getHolderClasses( $params ) {
		...
		$holderClasses[] = ! empty( $params['image_behavior'] ) ? 'edgt-image-behavior-' . $params['image_behavior'] : '';
