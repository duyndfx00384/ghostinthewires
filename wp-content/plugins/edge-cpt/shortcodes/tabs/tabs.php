...
class Tabs implements Lib\ShortcodeInterface {
		...
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					...
					'base'            => $this->getBase(),
					'as_parent'       => array( 'only' => 'edgt_tabs_item' ),
	...
	public function render( $atts, $content = null ) {
		...
		$output = edgt_core_get_shortcode_module_template_part( 'templates/tab-template', 'tabs', '', $params );
	...
	private function getHolderClasses( $params ) {
		...
		$holderClasses[] = ! empty( $params['type'] ) ? 'edgt-tabs-' . esc_attr( $params['type'] ) : 'edgt-tabs-standard';
