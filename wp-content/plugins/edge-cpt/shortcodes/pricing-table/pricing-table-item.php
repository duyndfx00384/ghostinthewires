...
class PricingTableItem implements Lib\ShortcodeInterface {
	...
	function __construct() {
		$this->base = 'edgt_pricing_table_item';
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Edge Pricing Table Item', 'edge-cpt' ),
					'base'                      => $this->base,
					'icon'                      => 'icon-wpb-pricing-table-item extended-custom-icon',
					'category'                  => esc_html__( 'by EDGE', 'edge-cpt' ),
					'allowed_container_element' => 'vc_row',
					'as_child'                  => array( 'only' => 'edgt_pricing_table' ),
					'params'                    => array(
						array(
							'type'        => 'textfield',
						...
						array(
							...
							'heading'    => esc_html__( 'Content Background Color', 'edge-cpt' )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'title',
						...
						array(
							...
							'heading'    => esc_html__( 'Title Bottom Border Color', 'edge-cpt' ),
							'dependency' => array( 'element' => 'title', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'heading'    => esc_html__( 'Price Color', 'edge-cpt' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Currency Color', 'edge-cpt' ),
						...
						array(
							...
							'value'       => esc_html__( 'BUY NOW', 'edge-cpt' ),
							'save_always' => true
						),
						array(
							'type'       => 'textfield',
	...
	public function render( $atts, $content = null ) {
		...
		$html = edgt_core_get_shortcode_module_template_part( 'templates/pricing-table-template', 'pricing-table', '', $params );
	...
	private function getHolderClasses( $params ) {
        ...
        if($params['active'] == 'yes') {
            $holderClasses[] = 'edgt-price-table-active';
        }
