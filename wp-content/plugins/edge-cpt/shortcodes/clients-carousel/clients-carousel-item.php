...
class ClientsCarouselItem implements Lib\ShortcodeInterface {
	...
	public function __construct() {
		$this->base = 'edgt_clients_carousel_item';
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                    => esc_html__( 'Edge Clients Carousel Item', 'edge-cpt' ),
					'base'                    => $this->getBase(),
					'category'                => esc_html__( 'by EDGE', 'edge-cpt' ),
					'icon'                    => 'icon-wpb-clients-carousel-item extended-custom-icon',
					'as_child'                => array( 'only' => 'edgt_clients_carousel' ),
	...
	public function render( $atts, $content = null ) {
		...
		$html = edgt_core_get_shortcode_module_template_part( 'templates/clients-carousel-item', 'clients-carousel', '', $params );
