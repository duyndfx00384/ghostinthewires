...
class ClientsCarousel implements Lib\ShortcodeInterface {
	...
	public function __construct() {
		$this->base = 'edgt_clients_carousel';
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'            => esc_html__( 'Edge Clients Carousel', 'edge-cpt' ),
					'base'            => $this->getBase(),
					'category'        => esc_html__( 'by EDGE', 'edge-cpt' ),
					'icon'            => 'icon-wpb-clients-carousel extended-custom-icon',
					'as_parent'       => array( 'only' => 'edgt_clients_carousel_item' ),
					...
					'params'          => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Items Hover Animation', 'edge-cpt' ),
							'value'       => array(
								esc_html__( 'Pulse', 'edge-cpt' ) 		   => 'pulse-image',
								esc_html__( 'Switch Images', 'edge-cpt' ) => 'switch-images',
								esc_html__( 'Roll Over', 'edge-cpt' )     => 'roll-over'
							),
							'save_always' => true
						)
					)
	...
	public function render( $atts, $content = null ) {
		...
		$html = edgt_core_get_shortcode_module_template_part( 'templates/clients-carousel', 'clients-carousel', '', $params );
	...
	private function getHolderClasses( $params ) {
		...
		$holderClasses[] = ! empty( $params['items_hover_animation'] ) ? 'edgt-cc-hover-' . $params['items_hover_animation'] : 'edgt-cc-hover-switch-images';
