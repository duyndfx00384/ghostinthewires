...
$course_curriculum_desc = get_post_meta(get_the_ID(), 'edgt_course_curriculum_desc_meta', true);
if(!empty($course_sections)) { ?>
    <div class="edgt-course-curriculum">
        <div class="edgt-curriculum-description">
            <h3 class="edgt-curriculum-title"><?php esc_html_e('Course Curriculum', 'edge-lms'); ?></h3>
            <p><?php echo esc_attr( $course_curriculum_desc); ?></p>
        </div>
        <div class="edgt-course-curriculum-list">
            <?php foreach($course_sections as $course_section) { ?>
                <div class="edgt-curriculum-section">
                    ...
                    <div class="edgt-section-content">
                        ...
                        <p class="edgt-section-description">
