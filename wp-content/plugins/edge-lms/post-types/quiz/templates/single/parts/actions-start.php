<form action='' method='post' class="edgt-lms-start-quiz-form">
    <input type='hidden' name='edgt_lms_questions' value='<?php echo esc_attr($questions); ?>' />
    <input type='hidden' name='edgt_lms_quiz_id' value='<?php echo esc_attr(get_the_ID()); ?>' />
    <input type='hidden' name='edgt_lms_course_id' value='<?php echo esc_attr($course_id); ?>' />
    <input type='hidden' name='edgt_lms_retake_id' value='<?php echo esc_attr($retakes_taken); ?>' />
